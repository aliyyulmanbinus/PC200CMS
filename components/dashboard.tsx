      ...
      <div className="flex gap-2 items-center">
        <div className="flex-1 relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-10 py-2 rounded-md border border-input bg-background text-foreground placeholder-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent"
          />
          {searchQuery && (
            <button
          ...
          <Card key={obj.id} className="p-4">
            <div className="space-y-3">
              <div className="flex items-start justify-between">
                <div>
                  <h3 className="font-semibold text-foreground">{obj.objectDisplayName}</h3>
                  <p className="text-sm text-muted-foreground font-mono">{obj.id}</p>
                </div>
              ...
              <div className="space-y-1 text-sm">
                ...
                <p className="text-muted-foreground">
                  <span className="font-semibold text-foreground">Description:</span> {obj.description}
                </p>
              </div>
              <div className="flex gap-2 pt-2">
                <Button variant="outline" size="sm" onClick={() => onEdit(obj)} className="flex-1 gap-2">
                  <Pencil className="w-4 h-4" />
                  Edit
                </Button>
                <Button variant="destructive" size="sm" onClick={() => onDelete(obj)} className="flex-1 gap-2">
                  <Trash2 className="w-4 h-4" />
                  Delete
                </Button>
              </div>
